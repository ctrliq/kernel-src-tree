...
Existing GitLab account holders can associate their redhat.com email address to their account at https://gitlab.com/profile/emails[https://gitlab.com/profile/emails], and should note the required change for https://docs.google.com/document/d/17AIthPv1jCPWc9MdxKFMo55JG4sZERKpeo_uKtiEc8s/edit?ts=601c08b2#heading=h.ajgvrb7w20j[GitLab Public Email Configuration].  The redhat.com email address must be changed to the primary address on the account at https://gitlab.com/profile[https://gitlab.com/profile].  
...
If you do not have a GitLab account, go to https://gitlab.com/users/sign_in[https://gitlab.com/users/sign_in] and create a new account with your redhat.com email address.  Users should note the required change for https://docs.google.com/document/d/17AIthPv1jCPWc9MdxKFMo55JG4sZERKpeo_uKtiEc8s/edit?ts=601c08b2#heading=h.ajgvrb7w20j[GitLab Public Email Configuration].
...
Users can automatically create a new account with their Red Hat username by logging into the https://auth.redhat.com/auth/realms/EmployeeIDP/protocol/saml/clients/gitlab-groups-redhat[Red Hat GitLab SAML].  The login process will detect that no account is associated with the redhat.com email address and create a new account.  If your Red Hat username is already in use by another GitLab account the creation process will append a number to your username, for example, “prarit3” instead of “prarit”.  Users should note the required change for https://docs.google.com/document/d/17AIthPv1jCPWc9MdxKFMo55JG4sZERKpeo_uKtiEc8s/edit?ts=601c08b2#heading=h.ajgvrb7w20j[GitLab Public Email Configuration].
...
Some users have noted issues with ipv6 and accessing https://www.gitlab.com[https://www.gitlab.com] over ssh.  You can work around these problems by adding
