...
=== Configuring Jira and GitLab accounts

* Create and configure your https://issues.redhat.com[Red Hat Jira account].
.. Red Hat Partners must coordinate with Red Hat Ecosystem Partner Management to properly associate their account with GitLab.
+
