...
EXPORT_SYMBOL(hdac_bus_eml_get_count);
...
EXPORT_SYMBOL(hdac_bus_eml_enable_interrupt);
...
EXPORT_SYMBOL(hdac_bus_eml_check_interrupt);
...
EXPORT_SYMBOL(hdac_bus_eml_set_syncprd_unlocked);

int hdac_bus_eml_sdw_set_syncprd_unlocked(struct hdac_bus *bus, u32 syncprd)
{
	return hdac_bus_eml_set_syncprd_unlocked(bus, true, AZX_REG_ML_LEPTR_ID_SDW, syncprd);
}
EXPORT_SYMBOL(hdac_bus_eml_sdw_set_syncprd_unlocked);
...
EXPORT_SYMBOL(hdac_bus_eml_wait_syncpu_unlocked);

int hdac_bus_eml_sdw_wait_syncpu_unlocked(struct hdac_bus *bus)
{
	return hdac_bus_eml_wait_syncpu_unlocked(bus, true, AZX_REG_ML_LEPTR_ID_SDW);
}
EXPORT_SYMBOL(hdac_bus_eml_sdw_wait_syncpu_unlocked);
...
EXPORT_SYMBOL(hdac_bus_eml_sync_arm_unlocked);

void hdac_bus_eml_sdw_sync_arm_unlocked(struct hdac_bus *bus, int sublink)
{
	hdac_bus_eml_sync_arm_unlocked(bus, true, AZX_REG_ML_LEPTR_ID_SDW, sublink);
}
EXPORT_SYMBOL(hdac_bus_eml_sdw_sync_arm_unlocked);
...
EXPORT_SYMBOL(hdac_bus_eml_sync_go_unlocked);

int hdac_bus_eml_sdw_sync_go_unlocked(struct hdac_bus *bus)
{
	return hdac_bus_eml_sync_go_unlocked(bus, true, AZX_REG_ML_LEPTR_ID_SDW);
}
EXPORT_SYMBOL(hdac_bus_eml_sdw_sync_go_unlocked);
...
EXPORT_SYMBOL(hdac_bus_eml_check_cmdsync_unlocked);

bool hdac_bus_eml_sdw_check_cmdsync_unlocked(struct hdac_bus *bus)
{
	return hdac_bus_eml_check_cmdsync_unlocked(bus, true, AZX_REG_ML_LEPTR_ID_SDW);
}
EXPORT_SYMBOL(hdac_bus_eml_sdw_check_cmdsync_unlocked);
...
EXPORT_SYMBOL(hdac_bus_eml_power_up);

int hdac_bus_eml_power_up_unlocked(struct hdac_bus *bus, bool alt, int elid, int sublink)
{
	return hdac_bus_eml_power_up_base(bus, alt, elid, sublink, false);
}
EXPORT_SYMBOL(hdac_bus_eml_power_up_unlocked);
...
int hdac_bus_eml_sdw_set_lsdiid(struct hdac_bus *bus, int sublink, int dev_num)
{
	...
	return 0;
} EXPORT_SYMBOL(hdac_bus_eml_sdw_set_lsdiid);
...
EXPORT_SYMBOL(hda_bus_ml_put_all);
...
EXPORT_SYMBOL(hda_bus_ml_reset_losidv);
...
EXPORT_SYMBOL(hda_bus_ml_resume);
...
EXPORT_SYMBOL(hda_bus_ml_suspend);
...
EXPORT_SYMBOL(hdac_bus_eml_get_mutex);
...
EXPORT_SYMBOL(hdac_bus_eml_ssp_get_hlink);
...
EXPORT_SYMBOL(hdac_bus_eml_dmic_get_hlink);
...
EXPORT_SYMBOL(hdac_bus_eml_sdw_get_hlink);
...
EXPORT_SYMBOL(hdac_bus_eml_enable_offload);
