...
EXPORT_SYMBOL_GPL(hda_codec_jack_wake_enable);
...
EXPORT_SYMBOL_GPL(hda_codec_jack_check);
...
EXPORT_SYMBOL_GPL(hda_codec_probe_bus);
...
EXPORT_SYMBOL_GPL(hda_codec_check_for_state_change);
...
EXPORT_SYMBOL_GPL(hda_codec_detect_mask);
...
EXPORT_SYMBOL_GPL(hda_codec_init_cmd_io);
...
EXPORT_SYMBOL_GPL(hda_codec_resume_cmd_io);
...
EXPORT_SYMBOL_GPL(hda_codec_stop_cmd_io);
...
EXPORT_SYMBOL_GPL(hda_codec_suspend_cmd_io);
...
EXPORT_SYMBOL_GPL(hda_codec_rirb_status_clear);
...
EXPORT_SYMBOL_GPL(hda_codec_set_codec_wakeup);
...
EXPORT_SYMBOL_GPL(hda_codec_check_rirb_status);
...
EXPORT_SYMBOL_GPL(hda_codec_device_remove);
...
EXPORT_SYMBOL_GPL(hda_codec_i915_display_power);
