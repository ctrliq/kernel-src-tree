...
EXPORT_SYMBOL_GPL(sof_client_dev_register);
...
EXPORT_SYMBOL_GPL(sof_client_dev_unregister);
...
EXPORT_SYMBOL_GPL(sof_client_ipc_tx_message);
...
EXPORT_SYMBOL_GPL(sof_suspend_clients);
...
EXPORT_SYMBOL_GPL(sof_resume_clients);

struct dentry *sof_client_get_debugfs_root(struct sof_client_dev *cdev)
{
	return cdev->sdev->debugfs_root;
}
EXPORT_SYMBOL_GPL(sof_client_get_debugfs_root);
...
EXPORT_SYMBOL_GPL(sof_client_get_dma_dev);
...
EXPORT_SYMBOL_GPL(sof_client_get_fw_version);
...
EXPORT_SYMBOL_GPL(sof_client_get_ipc_max_payload_size);
...
EXPORT_SYMBOL_GPL(sof_client_get_ipc_type);
...
EXPORT_SYMBOL_GPL(sof_client_core_module_get);
...
EXPORT_SYMBOL_GPL(sof_client_core_module_put);
...
EXPORT_SYMBOL_GPL(sof_client_register_ipc_rx_handler);
...
EXPORT_SYMBOL_GPL(sof_client_unregister_ipc_rx_handler);
...
EXPORT_SYMBOL_GPL(sof_client_register_fw_state_handler);
...
EXPORT_SYMBOL_GPL(sof_client_unregister_fw_state_handler);
...
EXPORT_SYMBOL_GPL(sof_client_get_fw_state);
