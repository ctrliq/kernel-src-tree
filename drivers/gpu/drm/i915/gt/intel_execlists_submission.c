...
{
	struct i915_sched_engine *sched_engine = (void *)data;
...
int intel_execlists_submission_setup(struct intel_engine_cs *engine)
{
	...
	tasklet_init(&engine->sched_engine->tasklet, execlists_submission_tasklet,
		     (unsigned long)engine->sched_engine);
			 ...
			 unsigned long flags)
{
	...
	tasklet_init(&ve->base.sched_engine->tasklet, virtual_submission_tasklet,
		     (unsigned long)ve->base.sched_engine);
