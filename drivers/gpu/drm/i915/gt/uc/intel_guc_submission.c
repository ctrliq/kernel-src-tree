...
deadlk:
	sched_engine->tasklet.func = NULL;
...
{
	return !sched_engine->tasklet.func;
}
...
int intel_guc_submission_setup(struct intel_engine_cs *engine)
{
	...
	if (!guc->sched_engine) {
		...
		tasklet_init(&guc->sched_engine->tasklet, guc_submission_tasklet,
			     (unsigned long)guc->sched_engine);
	}
