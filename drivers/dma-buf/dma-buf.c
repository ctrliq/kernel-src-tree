...
EXPORT_SYMBOL_GPL(dma_buf_map_attachment_unlocked);
...
EXPORT_SYMBOL_GPL(dma_buf_unmap_attachment_unlocked);
...
EXPORT_SYMBOL_GPL(dma_buf_vmap_unlocked);
...
EXPORT_SYMBOL_GPL(dma_buf_vunmap_unlocked);
