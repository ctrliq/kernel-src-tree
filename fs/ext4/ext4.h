...
#define EXT4_FL_USER_VISIBLE		0x324BDFFF /* User visible flags */
#define EXT4_FL_USER_MODIFIABLE		0x224BC0FF /* User modifiable flags */
...
#define EXT4_DAX_MUT_EXCL (EXT4_ENCRYPT_FL |\
