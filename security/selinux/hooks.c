...
static int selinux_mmap_file_common(struct file *file, unsigned long reqprot,
				    unsigned long prot, bool shared,
				    bool mounter_check)
{
	if (file) {
...
{
	return selinux_mmap_file_common(file, reqprot, prot,
				     ...
				     struct file *user_file __always_unused)
{
	...
	return selinux_mmap_file_common(backing_file, prot, prot,
