...
static struct sig_alg ecdsa_nist_p521 = {
	...
	.base = {
		...
		.cra_driver_name		= "fips-ecdsa-nist-p521-generic",
		.cra_priority		= 100000,
...
static struct sig_alg ecdsa_nist_p384 = {
	...
	.base = {
		...
		.cra_driver_name		= "fips-ecdsa-nist-p384-generic",
		.cra_priority		= 100000,
		.cra_module = THIS_MODULE,
		.cra_ctxsize = sizeof(struct ecc_ctx),
	},
...
static struct sig_alg ecdsa_nist_p256 = {
	...
	.base = {
		...
		.cra_driver_name		= "fips-ecdsa-nist-p256-generic",
		.cra_priority		= 100000,
		.cra_module = THIS_MODULE,
		.cra_ctxsize = sizeof(struct ecc_ctx),
	},
...
static struct sig_alg ecdsa_nist_p192 = {
	...
	.base = {
		...
		.cra_driver_name		= "fips-ecdsa-nist-p192-generic",
		.cra_priority		= 100000,
		.cra_module = THIS_MODULE,
		.cra_ctxsize = sizeof(struct ecc_ctx),
	},
