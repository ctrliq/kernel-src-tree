...
static struct crypto_alg aesni_cipher_alg = {
	.cra_name		= "aes",
	.cra_driver_name	= "fips-aes-aesni",
	.cra_priority		= 100000,
...
static struct skcipher_alg aesni_skciphers[] = {
	{
		.base = {
			.cra_name		= "ecb(aes)",
			.cra_driver_name	= "fips-ecb-aes-aesni",
			.cra_priority		= 100000,
			.cra_blocksize		= AES_BLOCK_SIZE,
			.cra_ctxsize		= CRYPTO_AES_CTX_SIZE,
			.cra_module		= THIS_MODULE,
		...
		.base = {
			.cra_name		= "cbc(aes)",
			.cra_driver_name	= "fips-cbc-aes-aesni",
			.cra_priority		= 100000,
			.cra_blocksize		= AES_BLOCK_SIZE,
			.cra_ctxsize		= CRYPTO_AES_CTX_SIZE,
			.cra_module		= THIS_MODULE,
		...
		.base = {
			...
			.cra_driver_name	= "fips-cts-cbc-aes-aesni",
			.cra_priority		= 100000,
			.cra_blocksize		= AES_BLOCK_SIZE,
			.cra_ctxsize		= CRYPTO_AES_CTX_SIZE,
			.cra_module		= THIS_MODULE,
		...
		.base = {
			.cra_name		= "ctr(aes)",
			.cra_driver_name	= "fips-ctr-aes-aesni",
			.cra_priority		= 100000,
			.cra_blocksize		= 1,
			.cra_ctxsize		= CRYPTO_AES_CTX_SIZE,
			.cra_module		= THIS_MODULE,
		...
		.base = {
			.cra_name		= "xts(aes)",
			.cra_driver_name	= "fips-xts-aes-aesni",
			.cra_priority		= 100000,
			.cra_blocksize		= AES_BLOCK_SIZE,
...
static struct skcipher_alg skcipher_algs_##suffix[] = {{		       \
	...
	.base.cra_driver_name	= "fips-xts-aes-" driver_name_suffix,	       \
	...
	.base.cra_driver_name	= "fips-ctr-aes-" driver_name_suffix,	       \
	.base.cra_priority	= priority,				       \
	...
	.base.cra_driver_name	= "fips-xctr-aes-" driver_name_suffix,	       \
	.base.cra_priority	= priority,				       \
	.base.cra_blocksize	= 1,					       \
	.base.cra_ctxsize	= CRYPTO_AES_CTX_SIZE,			       \
	.base.cra_module	= THIS_MODULE,				       \
...
DEFINE_AVX_SKCIPHER_ALGS(aesni_avx, "aesni-avx", 100000);
DEFINE_AVX_SKCIPHER_ALGS(vaes_avx2, "vaes-avx2", 100000);
DEFINE_AVX_SKCIPHER_ALGS(vaes_avx512, "vaes-avx512", 100000);
...
DEFINE_GCM_ALGS(aesni, /* no flags */ 0,
		"fips-generic-gcm-aesni", "fips-rfc4106-gcm-aesni",
		AES_GCM_KEY_AESNI_SIZE, 100000);

/* aes_gcm_algs_aesni_avx */
DEFINE_GCM_ALGS(aesni_avx, FLAG_AVX,
		"fips-generic-gcm-aesni-avx", "fips-rfc4106-gcm-aesni-avx",
		AES_GCM_KEY_AESNI_SIZE, 100000);

/* aes_gcm_algs_vaes_avx10_256 */
DEFINE_GCM_ALGS(vaes_avx10_256, FLAG_AVX10_256,
		"fips-generic-gcm-vaes-avx10_256", "fips-rfc4106-gcm-vaes-avx10_256",
		AES_GCM_KEY_AVX10_SIZE, 100000);

/* aes_gcm_algs_vaes_avx10_512 */
DEFINE_GCM_ALGS(vaes_avx10_512, FLAG_AVX10_512,
		"fips-generic-gcm-vaes-avx10_512", "fips-rfc4106-gcm-vaes-avx10_512",
		AES_GCM_KEY_AVX10_SIZE, 100000);

static int register_avx_algs(void)
{
	int err;
