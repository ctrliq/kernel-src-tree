...
void __sched rt_mutex_init_waiter(struct rt_mutex_waiter *waiter, bool savestate)
{
...
static __always_inline void __rt_mutex_lock(struct rt_mutex *lock, unsigned int subclass)
{
