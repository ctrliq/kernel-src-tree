 ...
 */
int ring_buffer_wait(struct trace_buffer *buffer, int cpu, bool full)
{
 ...
 */
int ring_buffer_record_is_on(struct trace_buffer *buffer)
{
 ...
 * the ring buffer.
 */
int ring_buffer_record_is_set_on(struct trace_buffer *buffer)
{
 ...
 */
struct ring_buffer_iter *
ring_buffer_read_prepare(struct trace_buffer *buffer, int cpu)
{
	struct ring_buffer_per_cpu *cpu_buffer;
