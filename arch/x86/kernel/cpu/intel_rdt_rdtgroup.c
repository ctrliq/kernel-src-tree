...
struct static_key rdt_mon_enable_key;
struct static_key rdt_alloc_enable_key;
				...
				void *data)
{
	...
	if (rdt_alloc_capable)
		static_key_slow_inc(&rdt_alloc_enable_key);
	if (rdt_mon_capable)
		static_key_slow_inc(&rdt_mon_enable_key);
		       ...
		       void *priv)
{
	...
	kn = __kernfs_create_file(parent_kn, name, 0444, 0,
				  &kf_mondata_ops, priv, NULL, true, NULL);
	if (IS_ERR(kn))
		return PTR_ERR(kn);
